...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleInsufficientBalance(InsufficientLeaveBalanceException ex) {
        return ResponseEntity
                .status(HttpStatus.BAD_REQUEST)
                .body(ApiResponse.error(ex.getMessage()));
    }
    ...
    public ResponseEntity<ApiResponse<Object>> handleLeaveOverlap(LeaveOverlapException ex) {
        return ResponseEntity
